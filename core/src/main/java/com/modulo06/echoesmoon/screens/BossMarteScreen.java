...
public class BossMarteScreen implements Screen {
    ...
    private void desenharHUD() {
        ...
        font.draw(batch, "PLANETA: MARTE — TITAN-FERRUGEM", 30, 115);
        if (boss.ativo) font.draw(batch, "TITAN-FERRUGEM", 600, 695);
